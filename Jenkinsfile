properties([
    ...
    parameters([
        ...
        [
          ...
          script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if (JobAction.equals("Enable") || JobAction.equals("Disable")) {
